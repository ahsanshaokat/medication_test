...
import BGLPlanComponent from './BGLPlanComponent';
import moment from 'moment';
import cloneDeep from 'lodash/cloneDeep';
import { BGLGetResource } from './PatientBGLRangesSource';
...
//import { getSettingsItem } from 'storage-utils';
//import { weightConverter, getUnitEnum } from 'react';
//import { YY_MM_DD } from 'constants';
let YY_MM_DD = 'YYYY-MM-DD';

function getSettingsItem(unit){ return unit; }
function weightConverter(unit){ return unit; }
function getUnitEnum(unit){ return unit; }
...
export default class MedicationReport extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loggedInUserId:
  ...
  updateReportStatus (reportId, status, patientId) {
    this.setState(
  ...
  showWarningConfirmation (status) {
    if (status === 10) {
      this.setState({
                  ...
                  <div className="row align-items-lg-center">
                    ...
                    <div className={`col ${config.buttonPadding}`}>
                      <div className="row align-items-end justify-content-between">
                        ...
                        <div className="col-auto">
                          <Link
                            to={`/patient-profile/${this.props.match.params.id}`}
                            state = {currentPatientDetails}
...
MedicationReport.propTypes = {
    location: React.PropTypes.object,
    history: React.PropTypes.array,
    match: React.PropTypes.object,
    dieticianSentToId: React.PropTypes.number,
};


MedicationReport.getStatusTextForCurrentPrevious =  (responseData, t) => {
    const statusText = '';
    if (responseData) {
      let prefix = '';
  ...
  MedicationReport.setRecepient = (recepientType, event) => {
